 ...
 */
package com.fitfreeak.fragment;
...
public class Camera2VideoFragment extends Fragment implements View.OnClickListener, FragmentCompat.OnRequestPermissionsResultCallback {
    ...
    private int DURATION_OF_TIMER = 10;
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        textCounter = (TextView) view.findViewById(R.id.timer);
            ...
            case R.id.info:
                {
                    Activity activity = getActivity();
                    if (null != activity) {
                        new AlertDialog.Builder(activity).setMessage("hello").setPositiveButton(android.R.string.ok, null).show();
                    }
                    break;
                }
            case R.id.camera:
    ...
    private void stopRecordingVideo() {
        ...
        if (null != activity) {
            ...
            getActivity().finish();
        /*Intent intent = new Intent(getActivity(), VideoPreviewScreen.class);
            intent.putExtra("url",mNextVideoAbsolutePath);
    ...
    /*getActivity().runOnUiThread(new Runnable(){
                ...
                @Override
                public void run() {
                    if(DURATION_OF_TIMER<=0){
                        stopRecordingVideo();
                    }else {
                        DURATION_OF_TIMER = DURATION_OF_TIMER - 1;
                        textCounter.setText("0:0"+(DURATION_OF_TIMER) + "");
                    }
                }});
        }
